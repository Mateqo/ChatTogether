#pragma checksum "D:\Users\User\Desktop\repozytorium\ChatTogether\ChatTogether\ChatTogether\Views\Home\Friends.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d85b1d94fd5757e3a0b2bbffc4d93b42dd00f194"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d85b1d94fd5757e3a0b2bbffc4d93b42dd00f194", @"/Views/Home/Friends.cshtml")]
...
#line hidden
#nullable disable
            WriteLiteral(")</p>\r\n                        <div class=\"friends-buttons\">\r\n                            <button class=\"btn-style friends-button\"");
            BeginWriteAttribute("id", " id=\"", 3243, "\"", 3265, 2);
            WriteAttributeValue("", 3248, "accept-", 3248, 7, true);
#nullable restore
#line 76 "D:\Users\User\Desktop\repozytorium\ChatTogether\ChatTogether\ChatTogether\Views\Home\Friends.cshtml"
WriteAttributeValue("", 3255, friend.Id, 3255, 10, false);

#line default
#line hidden
#nullable disable
            EndWriteAttribute();
            WriteLiteral(" onclick=\"acceptUserFunction()\"><i class=\"fas fa-user-plus\"></i></button>\r\n                            <button class=\"btn-style friends-button\"");
            BeginWriteAttribute("id", " id=\"", 3409, "\"", 3431, 2);
            WriteAttributeValue("", 3414, "reject-", 3414, 7, true);
#nullable restore
#line 77 "D:\Users\User\Desktop\repozytorium\ChatTogether\ChatTogether\ChatTogether\Views\Home\Friends.cshtml"
WriteAttributeValue("", 3421, friend.Id, 3421, 10, false);

#line default
#line hidden
#nullable disable
            EndWriteAttribute();
            WriteLiteral(" onclick=\"rejectUserFunction()\"><i class=\"fas fa-times\"></i></button>\r\n                        </div>\r\n                    </div>\r\n                </li>\r\n");
#nullable restore
    ...
    <div class=""modal-dialog"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                ...
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "d85b1d94fd5757e3a0b2bbffc4d93b42dd00f19416767", async() => {
            }
            );
...
#nullable disable
            EndWriteAttribute();
            WriteLiteral("></a>\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d85b1d94fd5757e3a0b2bbffc4d93b42dd00f19419438", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d85b1d94fd5757e3a0b2bbffc4d93b42dd00f19420478", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
...
<script type=""text/javascript"">
        ...
        setTimeout(() => {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        if (response[i].isSend == true )
                            $(""#addfriendsUl"").append('<li id=""' + ""userList"" + response[i].i");
            WriteLiteral(@"d + '"" class=""friends__ul-li""><img src=""/img/deafultphoto.jpg"" alt=""user profile photo"" class=""profile-photo""><div class=""profile-functions""><p class=""addfriends-name"">' + response[i].name + ' ' + response[i].surname + ' ' + '(' + response[i].nickName + ')' + '</p><div class=""friends-buttons""><button class=""btn-style addfriends-button"" data-id=""' + response[i].id + '"" onclick=""addUserFunction(' + response[i].id + ')""><i class=""fas fa-user-plus""></i></button></div></div></li>');
                        else
                            $(""#addfriendsUl"").append('<li id=""' + ""userList"" + response[i].id + '"" class=""friends__ul-li""><img src=""/img/deafultphoto.jpg"" alt=""user profile photo"" class=""profile-photo""><div class=""profile-functions""><p class=""addfriends-name"">' + response[i].name + ' ' + response[i].surname + ' ' + '(' + response[i].nickName + ')' + '</p><div class=""friends-buttons""><button class=""btn-style addfriends-button"" data-id=""' + response[i].id + '"" onclick=""addUserFunction(' + response[i].id + ");
            WriteLiteral(@"')""><i class=""fas fa-user-plus""></i></button></div></div></li>');
                    }
                },
    ...
    function addUserFunction(id) {
        $.ajax({
            ...
            dataType: 'json',
            success: function (response) {
                //$(""#newFriendsUl"").append('<li class=""friends__ul-li""><img src=""/img/deafultphoto.jpg"" alt=""user profile photo"" class=""profile-photo""><div class=""profile-functions""><p class=""addfriends-name"">' + response[i].name + ' ' + response[i].surname + ' ' + '(' + response[i].nickName + ')' + '</p><div class=""friends-buttons""><button class=""btn-style addfriends-but");
            WriteLiteral(@"ton"" id=""addFriendBtn""><i class=""fas fa-user-plus""></i></button></div></div></li>');
            },
            error: function (xhr, status) {
    ...
    //function acceptUserFunction(id) {
    //    $.ajax({
    ...
    //        success: function (response) {
    //            console.log('dziala');
    //            $(""#friendsUl"").append('<li class=""friends__ul-li""><img src=""/img/deafultphoto.jpg"" alt=""user profile photo"" class=""profile-photo""><div class=""profile-functions""><p class=""addfriends-name"">' + response[i].name + ' ' + response[i].surname + ' ' + '(' + response[i].nickName + ')' + '</p><div class=""friends-buttons""><button class=""btn-style addfriends-button"" data-id=""");
            WriteLiteral(@"' + response[i].id + '"" onclick=""acceptUserFunction(' + response[i].id + ')""><i class=""fas fa-user-plus""></i></button><button class=""btn-style addfriends-button"" data-id=""' + response[i].id + '"" onclick=""rejectUserFunction(' + response[i].id + ')""><i class=""fas fa-times""></i></button></div></div></li>');
    //        },
    //        error: function (xhr, status) {
    //            alert('Przepraszamy, wystąpił problem!');
    //        },
    ...
    //        success: function (response) {
    //            console.log('dziala');
    //            $(""#newFriendsUl"").remove('<li class=""friends__ul-li""><img src=""/img/deafultphoto.jpg"" alt=""user profile photo"" class=""profile-photo""><div class=""profile-functions""><p");
            WriteLiteral(@" class=""addfriends-name"">' + response[i].name + ' ' + response[i].surname + ' ' + '(' + response[i].nickName + ')' + '</p><div class=""friends-buttons""><button class=""btn-style addfriends-button"" data-id=""' + response[i].id + '"" onclick=""acceptUserFunction(' + response[i].id + ')""><i class=""fas fa-user-plus""></i></button><button class=""btn-style addfriends-button"" data-id=""' + response[i].id + '"" onclick=""rejectUserFunction(' + response[i].id + ')""><i class=""fas fa-times""></i></button></div></div></li>');
    //        },
    //        error: function (xhr, status) {
    //            alert('Przepraszamy, wystąpił problem!');
    //        },
